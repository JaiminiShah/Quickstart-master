...
//@Disabled
public class GG_Auto2025 extends OpMode
{
  ...
  /*  private DcMotor leftDrive = null;
    ...
    public void init() {
     ...
     /*   leftDrive  = hardwareMap.get(DcMotor.class, "left_drive");
      ...
      //  launcher.setMode(DcMotor.RunMode.RUN_USING_ENCODER);
         ...
         */
        drive.Launcher1.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,new PIDFCoefficients(300,0,0,10));
        drive.Launcher2.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER,new PIDFCoefficients(300,0,0,10));
    ...
    public void loop() {
            ...
            case WAIT_FOR_LAUNCH:
                ...
                if(launch(false)) {
                    ...
                    if(shotsToFire > 0) {
                        ...
                        drive.backLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        drive.backRightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        drive.frontLeftMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        drive.frontRightMotor.setMode(DcMotor.RunMode.STOP_AND_RESET_ENCODER);
                        drive.Launcher1.setVelocity(0);
                        drive.Launcher2.setVelocity(0);
        ...
        telemetry.addData("Motor Current Positions", "left (%d  %d), right (%d  %d)",
                drive.frontLeftMotor.getCurrentPosition(),drive.backLeftMotor.getCurrentPosition(), drive.frontRightMotor.getCurrentPosition(),drive.backLeftMotor.getCurrentPosition());
        telemetry.addData("Motor Target Positions", "left (%d   %d), right (%d   %d)",
                drive.frontLeftMotor.getTargetPosition(), drive.backLeftMotor.getTargetPosition(),drive.frontRightMotor.getTargetPosition(),drive.backRightMotor.getTargetPosition());
        telemetry.update();
    }
    ...
    boolean launch(boolean shotRequested){
        switch (launchState) {
            case IDLE:
                ...
                break;
            case PREPARE:
                drive.Launcher1.setVelocity(LAUNCHER_TARGET_VELOCITY);
                drive.Launcher2.setVelocity(LAUNCHER_TARGET_VELOCITY);
                if ((drive.Launcher1.getVelocity() > LAUNCHER_MIN_VELOCITY) && (drive.Launcher2.getVelocity()>LAUNCHER_MIN_VELOCITY)){
    ...
    boolean drive(double speed, double distance, DistanceUnit distanceUnit, double holdSeconds) {
        ...
        drive.frontLeftMotor.setTargetPosition((int) targetPosition);
        drive.frontRightMotor.setTargetPosition((int) targetPosition);
        drive.backLeftMotor.setTargetPosition((int)targetPosition);
        drive.backRightMotor.setTargetPosition((int)targetPosition);

        drive.frontLeftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        drive.frontRightMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        drive.backLeftMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);
        drive.backRightMotor.setMode(DcMotor.RunMode.RUN_TO_POSITION);

        drive.frontLeftMotor.setPower(speed);
        drive.frontRightMotor.setPower(speed);
        drive.backRightMotor.setPower(speed);
        drive.backLeftMotor.setPower(speed);
         ...
         */
        if(Math.abs(targetPosition - drive.frontLeftMotor.getCurrentPosition()) > (TOLERANCE_MM * TICKS_PER_MM)){
            driveTimer.reset();
        }
    ...
    boolean rotate(double speed, double angle, AngleUnit angleUnit, double holdSeconds){
        ...
        drive.frontLeftMotor.setTargetPosition((int) leftTargetPosition);
        drive.backLeftMotor.setTargetPosition((int)leftTargetPosition);
        drive.backRightMotor.setTargetPosition((int) rightTargetPosition);
        drive.backLeftMotor.setTargetPosition((int)rightTargetPosition);
        ...
        if((Math.abs(leftTargetPosition - drive.frontLeftMotor.getCurrentPosition())) > (TOLERANCE_MM * TICKS_PER_MM)){
            driveTimer.reset();
        }
